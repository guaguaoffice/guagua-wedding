    ...
    <form action={onSubmit} className="candidate-card flex flex-col gap-3">
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[12px] font-semibold text-text-soft w-[52px] flex-none flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-3.5 h-3.5 flex-none"><path d="M0 0h48v48H0z" fill="none"/><g fill="none"><path fill="#8fbffa" d="M24 1.5c-5.926 0-10.206.242-13.041.491c-3.3.29-5.765 2.887-5.993 6.152C4.74 11.408 4.5 16.597 4.5 24s.239 12.592.466 15.857s2.693 5.862 5.993 6.152c2.835.249 7.115.491 13.041.491s10.206-.242 13.041-.491c3.3-.29 5.765-2.887 5.993-6.152c.227-3.265.466-8.454.466-15.857s-.239-12.592-.466-15.857s-2.693-5.862-5.993-6.152C34.206 1.742 29.926 1.5 24 1.5"/><path fill="#2859c5" d="M43.5 24h-39c0 7.403.239 12.592.466 15.857s2.693 5.862 5.993 6.152c2.835.249 7.115.491 13.041.491s10.206-.242 13.041-.491c3.3-.29 5.765-2.887 5.993-6.152c.227-3.265.466-8.454.466-15.857"/><path fill="#8fbffa" d="M42.655 41.68a112 112 0 0 0-2.123-2.18c-3.59-3.59-6.206-5.77-7.99-7.079c-1.855-1.361-4.177-1.155-5.919.35c-1.56 1.35-3.86 3.464-7.123 6.728c-2.966 2.967-4.983 5.136-6.34 6.678c2.702.18 6.285.323 10.84.323c5.926 0 10.206-.242 13.041-.491a6.51 6.51 0 0 0 5.614-4.33M13.75 29a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5"/><path fill="#2859c5" fill-rule="evenodd" d="M11.25 9.5c0-.966.784-1.75 1.75-1.75h12a1.75 1.75 0 1 1 0 3.5H13a1.75 1.75 0 0 1-1.75-1.75m0 7.5c0-.966.784-1.75 1.75-1.75h22a1.75 1.75 0 1 1 0 3.5H13A1.75 1.75 0 0 1 11.25 17" clip-rule="evenodd"/></g></svg>
              網站
            </span>
            <input
              name="url"
